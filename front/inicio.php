    ...
    <div class="conteiner" style="background-color:lightgrey">
        <div class="row">
            ...
            <div class="col-10 col-md-9 col-sm-6">
                ...
                <div style="width:100px; height:30px;"><h4 style="margin-right:30px;"><a style="padding:10px;" class="text-white bg-dark" class="text-dark" href="inicio.php">Inicio</a></h4></div>
                <h4 style="margin-right:30px;"><a class="text-dark" href="empresas.php">Empresas</a></h4>
                <div style="margin-bottom:15px;">
                <button type="button" class="btn btn-default dropdown-toggle margin-bottom:10px;"
                        data-toggle="dropdown"><h4 style="margin-right:10px; margin-bottom:10px;">Tablas</h4><span class="caret"></span>
                    </button>
...
<footer class="text-center" style="background-color:lightgrey">Soluciones Navarro @Todos los derechos reservados</footer>
